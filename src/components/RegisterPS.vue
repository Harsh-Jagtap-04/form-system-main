<template>
      ...
      <div id="multi-step-form-container" class="mt-5">
        ...
        >
          ...
          <section id="step-1" class="form-step" :class="{ 'd-none': currentStep !== 1 }">
            <h1 class="text-center">Register Panchayat Samiti</h1>
            <!-- Step 1 input fields -->
            
            <div class="mt-3">
      <div class="form-group col">
        <label class="full-name-label" for="select-zp">ZP</label>
        <select id="select-zp" class="form-control">
    ...
    <option value="category-3">Category 3</option>
      ...
      <div class="form-group col">
        <label class="full-name-label" for="sp-name">Panchayat Samiti Name</label>
        <input type="text" id="ps-name" class="form-control" />
      </div>

      <div class="form-group col">
        <label class="full-name-label" for="pin-code">Pin Code</label>
        <input type="number" id="pin-code" class="form-control" />
      </div>
      <div class="form-group col">
      <label class="full-name-label" for="address">Address</label>
  ...
  <!-- </div> -->
    <!-- <div class="mt-3"> -->
      <div class="form-group col">
        <label class="full-name-label" for="contact-no">Contact Number</label>
        <input type="number" id="contact-no" class="form-control" />
      </div>
      <div class="form-group col">
        <label class="full-name-label" for="department">Department</label>
